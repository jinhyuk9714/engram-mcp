...
<p align="center">
  ...
  <a href="https://github.com/jinhyuk9714/engram-mcp/commits/main">
    <img src="https://img.shields.io/github/last-commit/jinhyuk9714/engram-mcp?style=flat&color=brightgreen" alt="Last Commit" />
  </a>
  <a href="LICENSE">
...
Engram MCP is a fragment-based persistent memory server implementing the Model Context Protocol (MCP). It gives stateless language model agents durable long-term memory that persists across session boundaries.
...
| `onboarding` | System onboarding | Self-guide for the AI to learn when and how to use Engram MCP tools. |
...
*Engram MCP — Fragment-Based Persistent Memory for Language Model Agents*
